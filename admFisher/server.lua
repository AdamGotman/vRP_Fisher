...
vRPcPescar = Tunnel.getInterface("vRP_constructor","vRP_constructor")

vRPPescar = {}
Tunnel.bindInterface("vRP_constructor",vRPPescar)
Proxy.addInterface("vRP_constructor",vRPPescar)
